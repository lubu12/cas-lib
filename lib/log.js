...
//
class Log {
  static errorLogFilePath; dbErrorLogFilePath; errorLogger; dbWriteLogger;
  ...
  //
  static initialize(errorLogFilePath, dbErrorLogFilePath) {
  ...
  static async log(urlPath, err, show, type) {
    ...
    var showConsole = (process.env.NODE_ENV !== "production");
    ...
    if (typeof show === 'undefined' ? showConsole : show) { console.log(err); }
  }
}
